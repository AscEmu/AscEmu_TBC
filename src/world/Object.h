...
class SERVER_DECL Object : public EventableObject
{
    ...
    const uint32 GetEntryFromGUID() const
    {
    ...
    std::set<Player*>::iterator GetInRangePlayerSetBegin() { return m_inRangePlayers.begin(); }
    ...
    bool IsInBg();
    uint32 GetTeam();
    virtual Group *GetGroup() { return NULL; } //objects directly cannot be in a group
