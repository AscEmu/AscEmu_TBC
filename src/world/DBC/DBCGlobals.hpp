 ...
 * Copyright (C) 2008-2011 <http://www.AscEmu.org/>
 *
...
namespace DBC
{
    ...
    {
        Log.Error("misc", "Size of '%s' set by format string (%u) is not equal to the size of the C++ structure (%u)", dbc_filename.c_str(), format_string_size, record_size);
