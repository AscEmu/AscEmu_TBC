...
--
-- Structure for table npc_script_text
--
CREATE TABLE IF NOT EXISTS `npc_script_text` (
  ...
  PRIMARY KEY (`entry`)
) ENGINE=MyISAM AUTO_INCREMENT=8759 DEFAULT CHARSET=utf8;

--
-- Data for table npc_script_text
--
INSERT INTO `npc_script_text` (`entry`, `text`, `creature_entry`, `id`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `broadcast_id`) VALUES
	...
	(2115, 'There it is! Wide open. Good luck to you conquering what lies beyond. I must report back to the Kirin Tor at once!', 3850, 0, 14, 7, 100, 1, 0, 0, 1334),
	(2116, 'Who dares interfere with the Sons of Arugal?', 4275, 0, 14, 0, 100, 0, 0, 0, 1435),
	(2117, 'Follow me and I\'ll open the courtyard door for you.', 3850, 0, 14, 7, 100, 1, 0, 0, 1331),
	(2118, 'I have just the spell to get this door open. Too bad the cell doors weren\'t locked so haphazardly.', 3850, 0, 14, 7, 100, 1, 0, 0, 1332),
	(2119, 'There we go! ', 3849, 0, 14, 1, 100, 0, 0, 0, 1323),
	(2120, 'Good luck with Arugal. I must hurry back to Hadrec now.', 3849, 0, 14, 1, 100, 0, 0, 0, 1324),
	(2121, 'You are indeed courageous for wanting to brave the horrors that lie beyond this door.', 3849, 0, 14, 1, 100, 0, 0, 0, 1321),
	(2122, 'Free from this wretched cell at last! Let me show you to the courtyard....', 3849, 0, 14, 1, 100, 0, 0, 0, 1320),
	...
	(3262, 'For once I agree with you... scum.', 3850, 0, 12, 7, 100, 1, 0, 0, 1329),
	...
	(5251, 'About time someone killed the wretch.', 3849, 0, 12, 1, 100, 0, 0, 0, 1328),
...
--
UPDATE `world_db_version` SET `LastUpdate` = '2015-11-10_02_npc_script_text' WHERE `LastUpdate` = '2015-11-10_01_world_db_version';
